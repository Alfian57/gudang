            ...
            <div class="row">
              ...
              <div class="col-lg-2 pr-0">
                <div class="form-group pt-3">
                  ...
                  <a href="modules/laporan-barang-keluar/cetak.php?tanggal_awal=<?php echo $tanggal_awal; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>"
              ...
              <div class="col-lg-2 pl-0">
                <div class="form-group pt-3">
                  ...
                  <a href="modules/laporan-barang-keluar/export.php?tanggal_awal=<?php echo $tanggal_awal; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>"
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-title">
            <i class="fas fa-file-alt mr-2"></i> Laporan Data Barang Keluar Tanggal
