...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <meta name="description" content="website persedian barang gudang " />
    <meta name="author" content="erlanggawijaya" />

    <!-- Title -->
    <title>Persediaan Barang Gudang</title>
        ...
        <div class="logo-header" data-background-color="white">
          ...
          <a href="?module=dashboard" class="logo">
            <div class="navbar-brand">
              ...
              <span class="text-black">udang Material</span>
            </div>
          </a>
          <!-- Navbar Toggler -->
                ...
                <ul class="dropdown-menu dropdown-user animated fadeIn">
                  ...
                  <li>
                    ...
                    <a class="dropdown-item" href="?module=form_ubah_password">
                      <i class="fas fa-user-lock mr-1"></i> Ganti Password
                    </a>
                    <div class="dropdown-divider"></div>
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="copyright ml-auto">
              Copyright &copy; 2025 - <a href="#" class="text-secondary">Kelompok RPL</a>.
            </div>
          </div>
        </footer>
        <!-- End Footer -->
