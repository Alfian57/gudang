...
<body class="login">
  ...
  <div class="wrapper wrapper-login">
    <div class="container container-login animated fadeIn">
      ...
      <!-- judul -->
      <h3 class="text-center">Persediaan Barang <br>Gudang </h3>
      <!-- form login -->
      <form action="proses_login.php" method="post" class="needs-validation" novalidate>
        <div class="form-group form-floating-label">
          ...
          <input type="text" id="username" name="username" class="form-control input-border-bottom" autocomplete="off"
            required>
        ...
        <div class="login-footer mt-4">
          <span class="msg">&copy; Kelompok RPL - 2025</span>
        </div>
      </form>
    </div>
  </div>
